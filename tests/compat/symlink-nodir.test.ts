...
describe.skipIf(isWindows)('Symlink + Nodir Interaction', () => {
  ...
  beforeAll(async () => {
    ...
    fs.symlinkSync(
      ...
      path.join(fixtureDir, 'symlink-to-dir')
    )
    fs.symlinkSync(
  ...
  describe('nodir: true + follow: true should skip symlinks to directories', () => {
    it('glob: nodir:true + follow:true should exclude symlinks-to-dirs', async () => {
      const results = sortResults(await glob.glob('*', { 
        cwd: fixtureDir, 
        nodir: true, 
        follow: true,
        posix: true 
    ...
    it('globSync: nodir:true + follow:true should exclude symlinks-to-dirs', () => {
      const results = sortResults(glob.globSync('*', { 
        cwd: fixtureDir, 
        nodir: true, 
        follow: true,
        posix: true 
    ...
    it('globlin: nodir:true + follow:true should exclude symlinks-to-dirs', async () => {
      ...
      const results = sortResults(await globlin.glob('*', { 
        cwd: fixtureDir, 
        nodir: true, 
        follow: true,
        posix: true 
    ...
    it('globlinSync: nodir:true + follow:true should exclude symlinks-to-dirs', () => {
      ...
      const results = sortResults(globlin.globSync('*', { 
        cwd: fixtureDir, 
        nodir: true, 
        follow: true,
        posix: true 
  ...
  describe('recursive patterns with nodir + follow', () => {
    it('glob: **/*.txt with nodir:true + follow:true finds files through followed symlinks', async () => {
      const results = sortResults(await glob.glob('**/*.txt', { 
        cwd: fixtureDir, 
        nodir: true, 
        follow: true,
        posix: true 
    ...
    it('globlin: **/*.txt with nodir:true + follow:true finds files through followed symlinks', async () => {
      ...
      const results = sortResults(await globlin.glob('**/*.txt', { 
        cwd: fixtureDir, 
        nodir: true, 
        follow: true,
        posix: true 
  ...
  describe('comparison tests: glob vs globlin', () => {
    it('* pattern with nodir:true + follow:true', async () => {
      ...
      const globResults = new Set(await glob.glob('*', { 
        cwd: fixtureDir, 
        nodir: true, 
        follow: true,
        posix: true 
      }))
      const globlinResults = new Set(await globlin.glob('*', { 
        cwd: fixtureDir, 
        nodir: true, 
        follow: true,
        posix: true 
    ...
    it('**/*.txt pattern with nodir:true + follow:true', async () => {
      ...
      const globResults = new Set(await glob.glob('**/*.txt', { 
        cwd: fixtureDir, 
        nodir: true, 
        follow: true,
        posix: true 
      }))
      const globlinResults = new Set(await globlin.glob('**/*.txt', { 
        cwd: fixtureDir, 
        nodir: true, 
        follow: true,
        posix: true 
